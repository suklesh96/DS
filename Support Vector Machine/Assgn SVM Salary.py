# -*- coding: utf-8 -*-
"""
Created on Tue May 24 17:36:22 2022
...
data_train=pd.read_csv('F:\\ExcelR\\Assignments\\Support Vector machine\\SalaryData_Train(1).csv')
data_train.shape
list(data_train)
data_train.dtypes

data_test=pd.read_csv('F:\\ExcelR\\Assignments\\Support Vector machine\\SalaryData_Test(1).csv')
data_test.shape
list(data_test)
